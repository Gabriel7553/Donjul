...
export const MICRO_DEFS: MicroDef[] = [
  ...
  { key: 'vitaminA',    label: 'Vitamin A',   unit: 'mcg',  defaultTarget: 900,  color: '#C8932E', group: 'vitamins' },
  { key: 'vitaminC',    label: 'Vitamin C',   unit: 'mg',  defaultTarget: 90,   color: '#C8932E', group: 'vitamins' },
  { key: 'vitaminD',    label: 'Vitamin D',   unit: 'mcg',  defaultTarget: 20,   color: '#C8932E', group: 'vitamins' },
  { key: 'vitaminB12',  label: 'Vitamin B12', unit: 'mcg',  defaultTarget: 2.4,  color: '#C8932E', group: 'vitamins' },
